...
from train_rule_extraction_model.data_loader import DefaultDataset, DataCollatorForTokenClassification, read_json_for_token_classification, read_dict
from train_rule_extraction_model.arg_parser import arg_parser
import torch
import time
import os
from train_rule_extraction_model.try_gpu import try_gpu
...
if __name__ == "__main__":
    ...
    # saved_path = "./model/mengzi_rule_extraction"
    eval_model(training_args["validate_dataset"], "../data/tc_data.dict", saved_path, "./predict_data/"+saved_path.split("/")[-1]+"_test_result.txt", training_args)