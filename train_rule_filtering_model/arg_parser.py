...
def arg_parser():
    ...
    parser.add_argument("--train_dataset", type=str, default="../data/rule_filtering_train_base.json")
    parser.add_argument("--validate_dataset", type=str, default="../data/rule_filtering_validate.json")
