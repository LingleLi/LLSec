...
def generate_specification():
    for file in sorted(os.listdir("exp3_data/our_inputs")):
        if "input.json" in file:
            ...
            input_file="exp3_data/our_inputs/" + file
            output_file="exp3_data/our_outputs/" + filename + "_output.json"
            output_file_without_knowledge = "exp3_data/our_outputs/" + filename + "_output_without_knowledge.json"
            relation_file = "exp3_data/our_outputs/" + filename + "_relation.json"
            setting_file="exp3_data/our_inputs/setting.json"
            explicit_relation_file="exp3_data/our_outputs/" + filename + "_explicit_relation.json"
            implicit_relation_file="exp3_data/our_outputs/" + filename + "_implicit_relation.json"
