...
def exp2():
    summary_f = open("exp2_data/table4.csv", "w", encoding="utf-8")
    summary_f.write("数据集,数据集特征,,,领域专家,,非专家,,ChatGPT,,ChatGLM,,LLSec(无领域知识),,LLSec,\n")
    summary_f.write(",#规则,#DF,#依赖关系,#DF,FPI(%),#DF,FPI(%),#DF,FPI(%),#DF,FPI(%),#DF,FPI(%),#DF,FPI(%)\n")
    
    expert_num, expert_acc = compute_acc_expert(expert_dir="exp2_data/expert_result", specification_dir="exp2_data/specification")
    non_expert_num, non_expert_acc = compute_acc_non_expert(non_expert_dir = "exp2_data/non_expert_result", specification_dir = "exp2_data/specification")
    llm_num, llm_acc = compute_acc_llm(llm_dir="exp2_data/llm_result", specification_dir="exp2_data/specification")
    ours_num, ours_acc = compute_acc_ours(our_dir="exp2_data/our_outputs", specification_dir = "exp2_data/specification", without_knowledge=False)
    ours_num_noknowledge, ours_acc_noknowledge = compute_acc_ours(our_dir="exp2_data/our_outputs", specification_dir = "exp2_data/specification", without_knowledge=True)
    ...
    rule_num, relation_num, df_num = get_dataset_feature("exp2_data/dataset/", "exp2_data/specification/")
