...
output_dir=./output
predict_dir=./predict_data/rule_filtering
train_files=../data/rule_filtering_llama2_train.csv
validation_files=../data/rule_filtering_llama2_validate.csv
model_dir=./model/rule_filtering
